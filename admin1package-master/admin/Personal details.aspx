<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Personal details.aspx.cs" Inherits="admin.Personal_details" %>
                        ...
                        <li>
                            <div class="contents">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm" style="width: 80%;">
                                    ...
                                    <div class="col-sm">
                                        ...
                                        <asp:TextBox ID="TextBox1" runat="server" Style="width: 90%;" class="form-control" placeholder="First Name" aria-label="First name"></asp:TextBox>
                                    </div>
                                    <div class="col-sm">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm">
                                        ...
                                        <asp:TextBox ID="TextBox5" runat="server" Style="width: 90%;" class="form-control" placeholder="Aadhar Number" aria-label="Aadhar Number"></asp:TextBox>
                                    </div>
                                ...
                                <div class="row g-3">
                                    <div class="row g-3">
                                        <div class="col-sm">
                                            ...
                                            <asp:TextBox ID="TextBox7" runat="server" Style="width: 80%;" class="form-control" placeholder="Mobile Number" aria-label="Mobile Number"></asp:TextBox>
                                        </div>
                                        <div class="col-sm">
                                            <asp:Label ID="Label12" class="form-label" runat="server" Text="Alternate Mobile Number"></asp:Label><small style="color: red">*</small>
                                            <asp:TextBox ID="TextBox8" runat="server" Style="width: 80%;" class="form-control" placeholder="Alternate Mobile Number" aria-label="Alternate Mobile Number"></asp:TextBox>
                                        </div>
                                        <div class="col-sm">
                                            <asp:Label ID="Label18" class="form-label" runat="server" Text="Personal EmailAddress"></asp:Label><small style="color: red">*</small>
                                            <asp:TextBox ID="TextBox9" runat="server" class="form-control" Style="width: 80%;" placeholder="Personal EmailAddress" aria-label="Personal EmailAddress"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <asp:DropDownList ID="DropDownList3" Style="width: 80%" class="form-select" runat="server">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <asp:DropDownList ID="DropDownList4" Style="width: 80%" class="form-select" runat="server">
                        ...
                        <li>
                            <div class="contents">
                                ...
                                <div class="row g-3">
                                    <div class="col-sm" style="width: 80%;">
                                        <br />
                                        <asp:Label ID="Label6" runat="server" Text="Qualification" class="form-label"></asp:Label>
                                        <asp:TextBox ID="TextBox3" runat="server" Style="width: 90%;" class="form-control" placeholder="Qualification" aria-label="Qualification"></asp:TextBox>
                                    </div>
                                    <div class="col-sm">
                                        <br />
                                        <asp:Label class="form-label" ID="Label7" runat="server" Text="ID Card Number"></asp:Label>
                                        <asp:TextBox ID="TextBox4" runat="server" Style="width: 90%;" class="form-control" placeholder="ID Card Number" aria-label="ID Card Number"></asp:TextBox>
                                    </div>
                                    <div class="col-sm">
                                        <br />
                                        <asp:Label class="form-label" ID="Label10" runat="server" Text="User ID"></asp:Label>
                                        <asp:TextBox ID="TextBox6" runat="server" Style="width: 90%;" class="form-control" placeholder="User ID" aria-label="User ID"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </li>
